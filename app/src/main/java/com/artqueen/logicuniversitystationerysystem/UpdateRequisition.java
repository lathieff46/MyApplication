...
public class UpdateRequisition extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String empId = MainActivity.p.get("userId");
        final ListView list = (ListView) findViewById(R.id.updateRequitionLV);
        new AsyncTask<Void, Void, List<String>>() {
            @Override
            protected List<String> doInBackground(Void... params) {
                return Requisition.list(empId);
            }
            @Override
            protected void onPostExecute(List<String> result) {
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(UpdateRequisition.this,
